...
def login():
    try:
        ...
        return Response('Sorry, something went wrong! Hello' + str(ex), status=400, mimetype='application/json')
...
def createSaleOrder():
    ...
    try:
        ...
        if res == True:
            ...
            warehouse_data = models.execute_kw(login_data['db'], uid, login_data['dbpassword'], 'stock.warehouse', 'search_read', [
